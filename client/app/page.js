    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-sm p-8 md:p-16">
        ...
        <div className="flex items-center justify-between mb-20">
          <h1 className="text-xl font-semibold text-gray-800">VaultChain</h1>

          <button className="border border-gray-300 px-4 py-2 rounded-lg text-sm text-gray-800 hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-all duration-200">
            Connect Wallet
          </button>
        </div>
